...
<div class="wrapper">
  <div id="header">
<img src="whale.png" alt="whale" align="left"><h2><a href="index.php">Crypto Flow</a></h2></img>
...
<div class="wrapper">
  ...
  echo "</tr></thead>";
	 ...
	 mysqli_close($conn);
          ?>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
<br />	<b>Legend:&nbsp;</b></h4>
<ul>
<li>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	<span style="color: rgb(0, 0, 205);">Blue line</span>&nbsp;represents each hours transactions totalled together</h4>
</li>
<li>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	 <span style="color: rgb(255, 0, 0)">Red Line</span>&nbsp;is the bitcoin price at the end of the hour.</h4>
</li>
</ul>
<p>&nbsp;</p>

<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
        <strong>What does the data represent? </strong></h4>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
Bitcoin is a decentralized payment system, in order to achieve decentralization all payments must be publically viewable on the blockchain.
Therefore Bitcoin through its API allows Transactions to be viewed. cryptoflow.vip filters these transactions and focuses on whale movements.
<br />By filtering on 50,000k USD transactions, a signifant amount of money for most, we can total these up and sort them into an hourly total.
Using this data, we gather the price of the bitcoin and try to see if these large transactions had any effect on the price of crypto.<br />
</h4>

<span style="font-size: 20px;"><strong>What Each Graph Represents</strong></span></p>
<p>&nbsp;</p>
<ol>
<li>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	1st Graph is the total amount of bitcoins converted into USD that has been publically transferred on the public blockchain for payments over 50,000</h4>
</li>
<li>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	2nd graph is the same concept as 1st but focuses on transactions when the address come from an exchange.</h4>
</li>
<li>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	The 3rd graph is the same concept as 1st but focuses on transactions when the address is sent to an exchange.<br />
	&nbsp;</h4>
</li>
</ol>

<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	<strong>How is the data collected?</strong></h4>
<h4 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
All Data is verified on the blockchain and you can click on Result for a given time to view each transaction on the blockchain. The numbers are real.</h4>
<h3 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-weight: normal; line-height: normal;">
	<br />
	<b>Viewing other coins such as BCH, Ethereum, XRP, Litecoin and others?</b><br />
	<br />
	Premium Package is required to see other crypto please visit Alts link for more info</h3>
      </div>
      <div class="column">
        <div class="subnav">
...
Highcharts.chart('container', {
  ...
  title: {
    text: '<?php echo $date;?> Bitcoin vs Hourly $USD on All Transactions',
    style: {
      fontFamily: 'Times New Roman',
      fontWeight:'bold',
      fontSize:'25px',
...
Highcharts.chart('container1', {
  ...
  title: {
    text: '<?php echo $date;?> Bitcoin vs Hourly $Usd from exchange Transactions',
    style: {
      fontFamily: 'Times New Roman',
      fontWeight:'bold',
      fontSize:'25px',
...
Highcharts.chart('container2', {
  ...
  title: {
    text: '<?php echo $date;?>  Bitcoin vs Hourly $Usd TO exchange Transactions',
    style: {
      fontFamily: 'Times New Roman',
      fontWeight:'bold',
      fontSize:'25px',
